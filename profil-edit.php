...
<head>
    ...
    <title>Profil módosítása - FormulaType</title>
</head>
<body>
    <div class="header">
        <div class="logo">
            ...
            <a href="index.php" class="logo-name"><h1>FormulaType</h1></a>
        </div>
        <div class="kijelentkezes">
            <a href="profil-edit.php" class="profil-edit-link">Profil módosítása</a>
        ...
        <div class="box form-box">
            ...
            <?php
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $edit_query = mysqli_query($con, "UPDATE felhasznalok SET felhasznalonev='$nev', email='$email' WHERE id='$id'") or die("Error");
                    

                    if ($edit_query) {
                        echo "<div class='uzenet'><p>Profil sikeresen módosítva!</p></div> <br>";
                        echo "<a href='index.php'><button class='btn'>Vissza az oldalra</button>";
                    }
                    ...
                    while ($eredmeny = mysqli_fetch_assoc($query)) {
                        $res_nev = $eredmeny['felhasznalonev'];
                        $res_email = $eredmeny['email'];
                    }

            ?>
            
            <header>Profil módosítása</header>
            <form action="" method="post">
                <div class="field input">
                    <label for="felhasznalonev">Felhasználónév</label>
                    <input type="text" name="felhasznalonev" id="felhasznalonev" value="<?php echo $res_nev; ?>" required>
                </div>
                ...
                <div class="field">
                    <input type="submit" class="btn" name="submit" value="Módosítás" required>
                </div>
            </form>
        </div>
